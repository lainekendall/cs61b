...
public class MySortingAlgorithms {
    ...
    public static class InsertionSort implements SortingAlgorithm {
        @Override
        public void sort(int[] array, int k) {
            for (int farthest = 1; farthest < array.length; farthest++) {
    ...
    public static class SelectionSort implements SortingAlgorithm {
        ...
        public void sort(int[] array, int k) {
            for (int j = 0; j < array.length; j += 1) {
              int currMin = array[j];
              // System.out.println("curr min is: " + currMin);
              int currMinIndex = j;
              for (int i = j + 1; i < array.length; i += 1) {
                if (array[i] < currMin) {
                  currMin = array[i];
                  // System.out.println("curr min now is: " + currMin);
                  currMinIndex = i;
                }
              }
              array[currMinIndex] = array[j];
              array[j] = currMin;
            }
    ...
    public static class MergeSort implements SortingAlgorithm {
        ...
        public void sort(int[] array, int k) {            
          ...
          if (array.length == 1) {
            ...
            // System.out.println("first half len: " + firstHalf.length);
            int[] secondHalf = Arrays.copyOfRange(array, array.length/2, array.length);
            // System.out.println("second half len: " + secondHalf.length);
            sort(firstHalf, 0);
            sort(secondHalf, 0);
